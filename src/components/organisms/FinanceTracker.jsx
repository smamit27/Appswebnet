...
export const EXPENSE_CATEGORIES = ['Food & Dining', 'Milk/Paneer/Ghee', 'Mobile Recharge', 'Transport', 'Shopping', 'Bills & Utilities', 'Home Loan EMI', 'Investments', 'Credit Card Payment', 'House Help', 'Monthly Maintenance', 'Healthcare', 'Entertainment', 'Education', 'Others'];
...
const CATEGORY_ICONS = {
  ...
  'Food & Dining': '🍔', 'Milk/Paneer/Ghee': '🥛', 'Mobile Recharge': '📱', 'Transport': '🚗', 'Shopping': '🛍️',
...
const CATEGORY_COLORS = {
  'Food & Dining': '#FF6B6B', 'Milk/Paneer/Ghee': '#00CEC9', 'Mobile Recharge': '#fd79a8', 'Transport': '#4ECDC4', 'Shopping': '#FFE66D',
